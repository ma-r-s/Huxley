...
_Diagram notation: rounded nodes (`([STATE])`) are terminal — the system rests there. Square nodes (`(STATE)`) are transient — the coordinator moves through them and keeps going._
