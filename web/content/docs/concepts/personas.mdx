...
| `basicos`| Terse English counter-persona. Spanish and French available via `i18n` overrides. Two skills, minimal prompt. Good starting point for your own persona. |
