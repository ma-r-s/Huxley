...
| Persona  | Use case                                           |
|----------|---------------------------------------------------|
| `abuelos`| Spanish-speaking elderly user. Warm, slow, never says no. Loads audiobooks, news, radio, system, telegram, timers. |
| `basicos`| Terse counter-persona. Defaults to Spanish; English and French available via `i18n` overrides. Two skills, minimal prompt. Good starting point for your own persona. |
