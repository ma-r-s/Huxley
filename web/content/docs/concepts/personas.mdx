...
| Persona  | Use case                                           |
|----------|---------------------------------------------------|
| `abuelos`| Spanish-speaking elderly user. Warm, slow, never says no. Loads audiobooks, news, radio, system, telegram, timers. The canonical example. |
| `basicos`| Terse counter-persona. Two skills, no warmth. Useful for A/B testing skill behavior in different prompt registers. |
