...
Most personas just fall back gracefully. A request for `de` on a persona that only defines `es`, `en`, and `fr` overrides gets the primary language.
...
<Cards>
  <Card
    ...
    description="A real persona, every choice explained."
  />
  <Card
    href="/docs/cookbook"
    title="Cookbook"
