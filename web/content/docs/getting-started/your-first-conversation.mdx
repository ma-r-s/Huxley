...
<Callout type="info">
  BasicOS defaults to Spanish (`language_code: es` in `persona.yaml`). If you'd prefer English responses, change `language_code` and `transcription_language` to `en` and restart.
</Callout>
