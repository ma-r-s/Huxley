...
class Settings(BaseSettings):
    ...
    (e.g., HUXLEY_OPENAI_API_KEY). A .env file in the working directory
    is also read automatically.

    Persona-driven settings (system prompt, voice, language, skill list,
    per-skill config) live in `personas/<name>/persona.yaml` and are
    NOT in this file. This file is for runtime/infrastructure knobs only.
    """
