...
class StateMachine:
    ...
    def __init__(self) -> None:
        ...
        self._on_enter: dict[AppState, list[TransitionCallback]] = {}
        self._on_exit: dict[AppState, list[TransitionCallback]] = {}

    @property
    def state(self) -> AppState:
        return self._state

    def on_enter(self, state: AppState, callback: TransitionCallback) -> None:
        """Register a callback to run when entering a state."""
        self._on_enter.setdefault(state, []).append(callback)

    def on_exit(self, state: AppState, callback: TransitionCallback) -> None:
