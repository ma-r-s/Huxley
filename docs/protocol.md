...
| `claim_started`  | `{ claim_id: string, skill: string }`                                                                                                                | Pure observability — a skill just took ownership of the mic via `InputClaim`. Behavioral signal is the `input_mode` that fires alongside.                                                                                                                    |
