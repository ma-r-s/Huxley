...
| `huxley-skill-stocks`     | Voice-controlled stock quotes via Alpha Vantage. The reference skill — see [authoring.md](authoring.md) for the walkthrough. | `uv add huxley-skill-stocks`     | [stocks docs](https://github.com/ma-r-s/Huxley/blob/main/server/skills/stocks/README.md) | first-party |
